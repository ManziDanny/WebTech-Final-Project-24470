...
import net.danny.HotelReservationSystem.repository.RoleRep;
import net.danny.HotelReservationSystem.repository.UserRep;
import net.danny.HotelReservationSystem.temp.CurrentUser;

@Service
public class UserServiceImpl implements UserService {

    // service pattern to manage transactional
